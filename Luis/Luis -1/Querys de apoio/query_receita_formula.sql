 SELECT GR.RECIPE_NO
       ...
       ,CUSTO.CMPNTCOST_ID    
       ,CUSTO.COST_LEVEL
       ,CUSTO.COST_CMPNTCLS_ID
       ,CUSTO.COST_ANALYSIS_CODE
       ,CUSTO.CMPNT_COST
       ,CUSTO.COSTCALC_ORIG
       ,CUSTO.CALENDAR_CODE
       ,CUSTO.PERIOD_CODE
  ...
  FROM GMD_RECIPES GR      
      ...
      ,(SELECT ccdv.CMPNTCOST_ID
       ,ccdv.COST_LEVEL
       ,ccdv.COST_CMPNTCLS_ID
       ,ccdv.COST_ANALYSIS_CODE
       ,ccdv.CMPNT_COST
       ,ccdv.COSTCALC_ORIG           
       ,(select CALENDAR_CODE 
          from Cm_Cldr_Dtl
         WHERE PERIOD_id = ccdv.PERIOD_id
 ...
 WHERE GR.RECIPE_ID = GRPL.RECIPE_ID (+)
   ...
   --AND CUSTO.delete_mark  = GR.DELETE_MARK
   --AND CUSTO.ORGANIZATION_ID  = NVL(GR.CREATION_ORGANIZATION_ID,GR.OWNER_ORGANIZATION_ID)
   AND CUSTO.INVENTORY_ITEM_ID (+) = GRVR.INVENTORY_ITEM_ID        