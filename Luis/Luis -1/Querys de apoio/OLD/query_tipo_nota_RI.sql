SELECT OOD.ORGANIZATION_CODE ORGANIZACAO_INVENTARIO,
      ...
      'Propriedades' separador_propriedades,
      ...
      RIT.DOCUMENT_TYPE "Tipo de Documento Fiscal",
       ...
       'Interfaces' separador_interfaces,
       ...
       'Contas de Passivo' separador_conta_pass,
     ...
     (SELECT SEGMENT1 || '.' || SEGMENT2 || '.' || SEGMENT3 || '.' ||
       ...
       'Contas de Ativo' separador_conta_ativo,
