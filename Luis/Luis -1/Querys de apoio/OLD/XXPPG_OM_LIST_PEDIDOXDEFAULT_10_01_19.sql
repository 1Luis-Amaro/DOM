SELECT oh.*
  ...
  ,round((nvl(PRECO_LISTA_DEFAULT,0) - PRECO_VENDA_PEDIDO)/(CASE WHEN PRECO_LISTA_DEFAULT is null or PRECO_LISTA_DEFAULT = 0 THEN (CASE WHEN PRECO_VENDA_PEDIDO = 0 THEN 1 END) ELSE PRECO_LISTA_DEFAULT END)*100,2)||'%'  DIF_PERCENT
