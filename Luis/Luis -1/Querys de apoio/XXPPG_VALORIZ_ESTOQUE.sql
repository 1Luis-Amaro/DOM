SELECT GOD.ORGANIZATION_CODE ORGANIZACAO,
      ...
      (SELECT MCB.SEGMENT1 || ' - '|| MCB.SEGMENT2 || ' - '|| MCB.SEGMENT3 
                FROM APPS.MTL_ITEM_CATEGORIES MIC, APPS.MTL_CATEGORIES_B MCB
                   WHERE MSIB.ORGANIZATION_ID = MIC.ORGANIZATION_ID
                   AND MSIB.INVENTORY_ITEM_ID = MIC.INVENTORY_ITEM_ID
                   AND MCB.CATEGORY_ID = MIC.CATEGORY_ID
                   AND MIC.ORGANIZATION_ID = GPB.ORGANIZATION_ID 
                   AND MIC.CATEGORY_SET_ID = 1) "CATEGORIA DE INVENTARIO",
       (SELECT MCB.SEGMENT1 || ' - '|| MCB.SEGMENT2 || ' - '|| MCB.SEGMENT3 
                FROM APPS.MTL_ITEM_CATEGORIES MIC, APPS.MTL_CATEGORIES_B MCB
                   WHERE MSIB.ORGANIZATION_ID = MIC.ORGANIZATION_ID
                   AND MSIB.INVENTORY_ITEM_ID = MIC.INVENTORY_ITEM_ID
                   AND MCB.CATEGORY_ID = MIC.CATEGORY_ID
                   AND MIC.ORGANIZATION_ID = GPB.ORGANIZATION_ID 
                   AND MIC.CATEGORY_SET_ID = 1100000061) "CATEGORIA DE CUSTOS",
