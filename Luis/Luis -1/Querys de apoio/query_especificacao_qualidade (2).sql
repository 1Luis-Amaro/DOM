SELECT PV.SEGMENT1 COD_FORN
     ...
     , DECODE(STD.COST_TYPE_ID,NULL,'',to_char(ccd2.cmpnt_cost*CFIL.QUANTITY,'999G999G990D000000000')) TOT_STD
     , DECODE(PMAC.COST_TYPE_ID,NULL,'',to_char(ccd.cmpnt_cost*CFIL.QUANTITY,'999G999G990D000000000'))  TOT_PMAC       
     , PPV_SLA.VALOR_PPV_DR
     , PPV_SLA.VALOR_PPV_CR                            
     , to_char(((NVL(CFI.INVOICE_AMOUNT,0)) - (DECODE(STD.COST_TYPE_ID,NULL,0, ccd2.cmpnt_cost*CFIL.QUANTITY))),'999G999G990D000000000') FORM_PPV
     , MCBI.SEGMENT2 SBU
     , MCBI.SEGMENT3 PL                                 
 FROM CLL.CLL_F189_ENTRY_OPERATIONS CFEO
    , CLL.CLL_F189_INVOICES CFI
    , CLL.CLL_F189_INVOICES CFI1
    , CLL.CLL_F189_FISCAL_ENTITIES_ALL CFFEA
    , APPS.PO_VENDORS PV
    , APPS.PO_VENDOR_SITES_ALL PVSA
    , APPLSYS.FND_USER FU
    , CLL.CLL_F189_INVOICE_LINES CFIL
    , CLL.CLL_F189_ITEM_UTILIZATIONS CFIU
    , CLL.CLL_F189_FISCAL_OPERATIONS CFFO
    ...
    , CLL.CLL_F189_FISCAL_CLASS CFFC
    , AP.AP_AWT_GROUPS AWG
    , CLL.CLL_F189_SERVICE_TYPES CFST         
    , HR.HR_ALL_ORGANIZATION_UNITS HAOU         
    , INV.MTL_CATEGORIES_B MCBI
    , APPS.MTL_CATEGORY_SETS_V MCSI
    , INV.MTL_ITEM_CATEGORIES MICI                  
    , INV.MTL_CATEGORIES_B MCBC
    , APPS.MTL_CATEGORY_SETS_V MCSC
    , INV.MTL_ITEM_CATEGORIES MICC         
    , GMF.GMF_PERIOD_STATUSES gps   
    , GMF.CM_CMPT_DTL ccd        
    , GMF.GMF_PERIOD_STATUSES gps2
    , GMF.CM_CMPT_DTL ccd2              
    , (SELECT COST_TYPE_ID FROM GMF.CM_MTHD_MST WHERE COST_MTHD_CODE = 'STD' AND ROWNUM = 1)    STD
    , (SELECT COST_TYPE_ID FROM GMF.CM_MTHD_MST WHERE COST_MTHD_CODE = 'PMAC' AND ROWNUM = 1)    PMAC         
    , (SELECT rct.transaction_id
            ,poh.po_header_id
       FROM PO.RCV_SHIPMENT_HEADERS rsh 
          , PO.RCV_SHIPMENT_LINES rsl 
          , PO.RCV_TRANSACTIONS rct 
