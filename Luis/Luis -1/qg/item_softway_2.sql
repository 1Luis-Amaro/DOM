SELECT DISTINCT   msi.segment1 item,
                  ...
                  case
                     when nvl(ril.importation_cofins_amount,1) > 0 then
                        round((ril.importation_cofins_amount / ril.importation_pis_cofins_base) * 100,2)
                     else
                        0
                  end case,
            ...
            WHERE     reo.status NOT IN ('CANCELLED', 'IN HOLD', 'IN REVERSION')
                  ...
                  and reo.source = 'SOFTWAY'
               --   and pov.segment1 = 'E000139'
                  ...
                  AND TRUNC (reo.receive_date) BETWEEN TRUNC (
                                                          NVL (TO_DATE ('2015/01/01', 'rrrr/mm/dd hh24:mi:ss'),
                                                               reo.receive_date))
                                                   AND TRUNC (
                                                          NVL (TO_DATE ('2016/09/30', 'rrrr/mm/dd hh24:mi:ss'),
                                                               reo.receive_date))
