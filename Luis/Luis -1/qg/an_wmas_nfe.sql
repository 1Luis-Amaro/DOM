SELECT mp.organization_id
        ...
        where 
              cfi.operation_id    = 80790 and 
              cfi.organization_id = 92 
            AND cfil.invoice_id                 = cfi.invoice_id
            and mmt.source_code                 = 'RCV'
            AND ( (rt.po_line_location_id IS NOT NULL AND cfil.line_location_id = rt.po_line_location_id) OR
            ...
            AND (rt.po_line_location_id IS NOT NULL OR
                 rt.requisition_line_id IS NOT NULL)
