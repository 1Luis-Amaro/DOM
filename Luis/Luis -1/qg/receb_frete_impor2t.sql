     SELECT (SELECT user_name
      ...
      WHERE     ri.organization_id = reo.organization_id
            ...
            AND cfi.organization_id = cfe.organization_id
            AND cfi.operation_id    = cfe.operation_id
            ...
            AND trunc(reo.receive_date) >= trunc(to_date('01-mar-2020'))
            AND reo.receive_date        <= trunc(to_date('31-mar-2020'))
