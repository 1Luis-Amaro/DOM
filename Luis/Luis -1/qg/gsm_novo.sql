...
select CFIL.*             
     ...
     WHERE cfil.organization_id      = cfi.organization_id
...
--       AND msi.consigned_flag        = 2
       ...
       --and cfi.invoice_num IN (4045072,30808, 76249)
