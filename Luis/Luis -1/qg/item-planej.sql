SELECT DISTINCT MSI.ITEM_TYPE               "Nome Template",
...
--       MP.ORGANIZATION_CODE        "Organizacao",
       MSI.DESCRIPTION             "Descricao do Item",
...
--       'N' "ITEM DE ENGENHARIA",
    ...
    --
    --   PLANNER_CODE,
       (SELECT DISTINCT FULL_NAME FROM apps.per_people_f PPF WHERE PPF.PERSON_ID = MSI.ATTRIBUTE16 AND ROWNUM = 1 and MSI.ATTRIBUTE16 < '999') "Comprador Comercial",
--       
...
--
 WHERE 1 = 1
 AND MP.ORGANIZATION_ID IN (92,86) -- (87)
...
--   AND MSI.ITEM_TYPE NOT IN('GEQ_SERVICO','SERVICO')
   ...
   and msi.item_type not in ('ACA','MP','INS/EMB','ACARV','INT','SEMI')
