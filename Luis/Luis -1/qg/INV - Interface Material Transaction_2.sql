...
where 1=1--mti.source_code = 'DHL'
  ...
  and error_explanation = 'Quantidade deve ser menor ou igual a Disponível para transacionar';
...
---- Verifica registros da interface ----
select distinct error_explanation, mti.process_flag 
       from apps.mtl_transactions_interface mti;
