SELECT DISTINCT NVL2(OOLA.ITEM_RELATIONSHIP_TYPE,'COMP','ACA')        TIPO_ARTICULO
                        ...
                        ,NULL                                                           DAT_PROD   
                        ,tab_batchno.batch_no --GBH.BATCH_NO  OSM 26/03/2015
                        ,tab_batchno.BATCH_ID --GBH.BATCH_ID  OSM 26/03/2015
                        ,RCL.WAREHOUSE_ID                                               ORGANIZATION_ID                       
                        ,MTLN.LOT_NUMBER                           
                        ,NULL                                                           FEC_EXP  
                  ...
                  WHERE RCT.CUSTOMER_TRX_ID               = RCL.CUSTOMER_TRX_ID 
                    ...
                    --
                    AND mmt.inventory_item_id             = mtln.inventory_item_id (+) -- OSM 26/03/2015
                    and tab_batchno.inventory_item_id (+) = mtln.inventory_item_id     -- OSM 26/03/2015
                    and tab_batchno.lot_number (+)        = mtln.lot_number            -- OSM 26/03/2015
                    --
                    AND RCT.TRX_NUMBER                    = '4549' --G_TRX_NUMBER
                    AND RCL.WAREHOUSE_ID                  = 92 --G_ORG_ID              
                    --
