operadores de comparação de multiple-row
in - igual a qualquer membro da lista
any - deve ser precedida por =,!=,>,<,<=,>= compara um valor para qualquer valor na lista retornada pela sub consulta. retorna FALSE se a sub consulta retorna nenhuma linha
all - deve ser precedida por =,!=,>,<,<=,>= compara um valor para todos os valores na lista retornada pela sub consulta retorna TRUE se a sub consulta retorna nenhuma linha  
