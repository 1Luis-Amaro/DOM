...
evitando o gasto de tempo com a leitura de todos os dados da tabela. Porém,
 o índice deve ser utilizado adequadamente, pois existem campos da tabela onde o índice não irá favorecer a consulta.
