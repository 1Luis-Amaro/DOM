...
DE VARCHAR2 OU CHAR PARA = DATA
DE NUMBER PARA = VARCHAR2 OU CHAR
DE DATE PARA = VARCHAR2 OU CHAR

DE NUMBER PARA CHARACTER = TO_CHAR
DE CHARACTER PARA NUMBER = TO_NUMBER
DE CHARACTER PARA DATE = TO_DATA 
DE DATE PARA CHARACTER = TO_CHAR
